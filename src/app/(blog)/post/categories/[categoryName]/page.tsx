...
export default async function CategoryNamePage({ params }: { params: { categoryName: string } }) {

  const res = await fetch(`https://dummyjson.com/posts/tag/${params.categoryName}`, { cache: 'no-store' });
  if (!res.ok) {
    notFound();
  }
